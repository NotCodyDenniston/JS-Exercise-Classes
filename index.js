...
class Car {
  ...
  drive(distance){
    ...
    if (distance > maxDistance){
      ...
      this.tank = 0;
      return this.ranOut = ( `I ran out of fuel at ${this.odometer} miles!`)
      
    } else {
      this.odometer += distance
      this.tank -= distance / this.milesPerGallon
      return this.madeIt = `We made it, and we still have ${this.tank} gallons left`
    }
  }
...
const lilUzi = new Lambdasian('lilUzi')
//console.log(lilUzi.speak())
/*
  TASK 4
